...
\hline
Point ($\epsilon$) & BB thr. & HCal thr. & $\eta_{det, e}$ & $\eta_{det, n}$ & $\eta_{det, p}$ & $\eta_{QE sel, n}$ & $\eta_{QE sel, p}$ \\
 & (GeV) & (GeV) &  &  &  \\
\hline
1 (0.599) & 1.32 & 1.06 & 0.902 & 0.904 & 0.892 & 0.589 & 0.605 \\ 
\hline
2 (0.838) & 2.99 & 0.09 & 0.808 & 0.889 & 0.882 & 0.617 & 0.647 \\
\hline
\end{tabular} 
\caption{Kinematics electron thresholds, particle detection efficiencies ($\eta_{det}$), and efficiency of quasi-elastic selection $\eta_{QE sel}$ separated for the proton and the neutron.}
\label{tab:kinEffs}
\end{table}
\end{center}
%
...
%
\begin{equation}
  F^2 = \frac{N_{QE}}{\cal{L}_{exp}\Delta t d\sigma_{Mott}/d\Omega \Delta\Omega \eta}
  \label{eq:F2}
\end{equation}
%
with $\Delta t$ the running time, $\Delta\Omega$ the convoluted BigBite-HCal solid angle, $\eta$ the product of all efficiencies (electron detection $\times$ nucleon detection $\times$ inelastic rejection selection), $\cal{L}_{exp}$ the experimental luminosity:
%
\begin{equation}
...
%
\begin{equation}
  \frac{d\sigma_{Mott}}{d\Omega} = \frac{a}{a}
\end{equation}
%
